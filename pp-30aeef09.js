...
class Interval {
    constructor(d, a, b) {
        ...
        this.fn = (x, y = new Float32Array(this.d)) => {
            const { a, b, d } = this;
            constants66Ce1Aa3.a.equal(x.length, d);
            constants66Ce1Aa3.a.equal(y.length, d);
            for (let i = 0; i < d; i++) {
                y[i] = a[i] + x[i] * (b[i] - a[i]);
            }
            return y;
        ...
        constants66Ce1Aa3.a.equal(a.length, d);
        constants66Ce1Aa3.a.equal(b.length, d);
        this.domain = d;
    }
}
...
//# sourceMappingURL=pp-30aeef09.js.map
