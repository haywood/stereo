import 'https://unpkg.com/systemjs@6.1.9/dist/system.js'
(function(l, r) { if (l.getElementById('livereloadscript')) return; r = l.createElement('script'); r.async = 1; r.src = '//' + (window.location.host || 'localhost').split(':')[0] + ':35729/livereload.js?snipver=1'; r.id = 'livereloadscript'; l.head.appendChild(r) })(window.document);
System.register(['./constants-3263b11a.js'], function (exports) {
  'use strict';
  var assert;
  return {
    ...
    execute: function () {
      ...
      const pp = exports('p', (a, p = 2) => JSON.stringify(a, null, p));

    }
  };
});
//# sourceMappingURL=pp-8fee3a5e.js.map
